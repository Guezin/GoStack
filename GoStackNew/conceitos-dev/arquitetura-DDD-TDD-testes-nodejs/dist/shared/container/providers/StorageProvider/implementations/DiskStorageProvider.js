    ...
    DiskStorageProvider.prototype.saveFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.promises.rename(path_1.resolve(upload_1.default.directory, file), path_1.resolve(upload_1.default.uploadsFolder, file))];
                    case 1:
                        _a.sent();
    ...
    DiskStorageProvider.prototype.deleteFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        filePath = path_1.resolve(upload_1.default.uploadsFolder, file);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);

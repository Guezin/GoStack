...
var FakeAppointmentsRepository = /** @class */ (function () {
    ...
    FakeAppointmentsRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.appoitments];
            });
        });
    };
    FakeAppointmentsRepository.prototype.findByDate = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            var findAppointment;
            return __generator(this, function (_a) {
                findAppointment = this.appoitments.find(function (appointment) {
    ...
    FakeAppointmentsRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                appoitment = new Appointment_1.default();
                Object.assign(appoitment, { id: uuidv4_1.uuid(), provider_id: provider_id, date: date });
                this.appoitments.push(appoitment);
                return [2 /*return*/, appoitment];
            });
        });
    };

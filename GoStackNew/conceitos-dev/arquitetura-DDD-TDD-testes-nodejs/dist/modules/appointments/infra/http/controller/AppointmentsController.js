...
var AppointmentsRepository_1 = __importDefault(require("../../typeorm/repositories/AppointmentsRepository"));
var AppointmentsController = /** @class */ (function () {
    ...
    AppointmentsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var appointmentRepository, appointmentsAll;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appointmentRepository = new AppointmentsRepository_1.default();
                        return [4 /*yield*/, appointmentRepository.findAll()];
                    case 1:
                        appointmentsAll = _a.sent();
                        return [2 /*return*/, response.json(appointmentsAll)];
                }
            });
        });
    };

...
describe('ResetPasswordService', function () {
    beforeEach(function () {
        ...
        resetPassword = new ResetPasswordService_1.default(fakeUsersRepository, fakeUserTokensRepository, fakeBCryptHash);
    });
    it('should be able to reset password', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    generateHash = jest.spyOn(fakeBCryptHash, 'generateHash');

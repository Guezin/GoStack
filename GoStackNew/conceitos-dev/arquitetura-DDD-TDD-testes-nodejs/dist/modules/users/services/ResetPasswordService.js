...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(userRepository, userTokensRepository, encryptedPassword) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _b = user;
                        return [4 /*yield*/, this.encryptedPassword.generateHash(password)];
                    case 3:
                        _b.password = _c.sent();
    ...
    ResetPasswordService = __decorate([
        ...
        __param(2, tsyringe_1.inject('ProviderEncryptedPassword')),

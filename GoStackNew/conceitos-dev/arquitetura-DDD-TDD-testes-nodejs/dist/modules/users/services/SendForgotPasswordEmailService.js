...
var SendForgotPasswordEmailService = /** @class */ (function () {
    function SendForgotPasswordEmailService(userRepository, mailProvider, userTokensRepository) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.mailProvider.sendMail(email, 'Recuperação de senha solicitado!')];
                    case 3:
                        _b.sent();
                        return [2 /*return*/];
                }

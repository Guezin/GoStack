...
var AuthenticateUserService = /** @class */ (function () {
    function AuthenticateUserService(userRepository, encryptedPassword) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.encryptedPassword.compareHash(password, user.password)];
                    case 2:
    ...
    AuthenticateUserService = __decorate([
        ...
        __param(1, tsyringe_1.inject('ProviderEncryptedPassword')),
